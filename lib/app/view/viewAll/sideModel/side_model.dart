...
class _SideModelState extends State<SideModel> {
  ...
  Widget build(BuildContext context) {
    ...
    final displayImage = selectedPokemon.sprites;
            ...
            children: [
              FutureBuilder<List<Color>>(
                future: const DominantColor().getDominantColorFromSvg(
                  displayImage?.other?.dream_world?.front_default ?? "",
                ),
          ...
          Container(
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  for (int nums = 0; nums < selectorLength; nums += 1)
                    Padding(
                      ...
                      child: GestureDetector(
                        ...
                        child: _selectedIndex == nums
                            ...
                            : AutoSizeText(
                                selector.elementAtOrNull(nums)?.toString() ??
                                    "",
