...
class NestedCardWidget extends StatelessWidget {
  ...
  void _handleTap(BuildContext context) {
    if (selectedIndex == index) {
      ...
      context.read<CardBloc>().add(CardTapped(index ?? 0));
    }
  }
                    ...
                    child: Center(
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          context.read<PokemonDetailsBloc>()
                            ..add(SetFetchedPokemon(fetchedPokeMons ?? []))
                            ..add(SetSelectedPokemon(pokemonData ?? Pokemon()));
